...
verilog-vivado-study/
  ...
  src/
    02_seven_segment/
    04_ultrasonic_sensor_lcd/
    05_tft_display/
  constraints/
  reports/
```

이 저장소는 원본 Vivado 프로젝트 전체를 올리는 대신, 직접 확인하기 쉬운 소스 코드와 제약 파일 중심으로 재구성했습니다.
...
| `constraints/02_seven_segment` | seven-segment 핀 제약 파일 |
| `constraints/04_ultrasonic_sensor_lcd` | 초음파 센서/LCD 핀 제약 파일 |
| `constraints/05_tft_display` | TFT display 핀 제약 파일 |
| `docs/notes` | 실습별 학습 노트 |
| `reports` | 결과 요약을 정리할 공간 |
